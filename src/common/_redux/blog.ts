...
import { Action, BlogState } from "./types";
...
function* getBlogShowSaga(action: Action) {
  try {
...
function* postBlogStoreSaga(action: Action) {
  try {
...
function* putBlogUpdateSaga(action: Action) {
  try {
...
function* deleteBlogDeleteSaga(action: Action) {
  try {
...
export const getBlogShow = (id: string) => ({
  type: GET_BLOG_SHOW,
  payload: { id },
});

export const postBlogStore = (data: any) => ({
  type: POST_BLOG_STORE,
  payload: { data },
});

export const putBlogUpdate = (data: any, id: string) => ({
  type: PUT_BLOG_UPDATE,
  payload: { data, id },
});

export const deleteBlogDelete = (id: string) => ({
