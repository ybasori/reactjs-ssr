...
81. create src/Pages/Blog/Create/index.js
    ```javascript
    import React from "react";
    ...
    ```
82. create src/Pages/Blog/Detail/index.js
    ```javascript
    import React from "react";
    ...
    ```
83. create file src/Pages/Blog/Main/index.js
    ```javascript
    import React from "react";
    import { Link } from "react-router-dom";
    ...
    ```
84. create file src/Pages/Blog/index.js
    ```javascript
...
85. edit src/App.js
    ...
    ```
86. edit src/Components/Navbar/index.js
    ```diff
    <div className="navbar-start">
        <NavLink className="navbar-item" to="/">
            Home
